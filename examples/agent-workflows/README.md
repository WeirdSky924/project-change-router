...
Use it when a repository already has a `project-change-router/` bundle generated by an older skill version.
...
- Rebuild the existing bundle, then validate, audit governance, check freshness, and run evaluation.
